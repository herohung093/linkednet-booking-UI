    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="prose prose-indigo max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            By accessing and using LinkedNet&apos;s services, you agree to be bound
            ...
            using or accessing our service.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            Permission is granted to temporarily access and use LinkedNet&apos;s
            services for personal, non-commercial transitory viewing only. This
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            LinkedNet provides an online booking and business management
            platform for salon owners. We reserve the right to modify, suspend,
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            You agree to pay all fees associated with your use of LinkedNet&apos;s
            services. All fees are non-refundable unless otherwise specified. We
            reserve the right to change our fees upon notice.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            LinkedNet shall not be liable for any indirect, incidental, special,
